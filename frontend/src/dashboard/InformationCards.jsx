    ...
    return (
        <div className='grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6'>
            <div className="bg-card shadow-lg rounded-lg p-6 flex flex-col items-center hover:bg-card/90 transition-colors duration-200">
                ...
                <p className="text-2xl font-bold text-primary mt-2">{conferencistas.length}</p>
            </div>

            {/* Card: Auditorios */}
            <div className="bg-card shadow-lg rounded-lg p-6 flex flex-col items-center hover:bg-card/90 transition-colors duration-200">
                <Speech  className="text-secondary w-12 h-12 mb-4" />
                <h3 className="text-xl font-semibold text-sec">Auditorios</h3>
                <p className="text-2xl font-bold text-secondary mt-2">{auditorios.length}</p>
            </div>
            ...
            <div className="bg-card shadow-lg rounded-lg p-6 flex flex-col items-center hover:bg-card/90 transition-colors duration-200">
                ...
                <p className="text-2xl font-bold text-primary mt-2">{reservas.length}</p>
            </div>
        </div>
    )
}
